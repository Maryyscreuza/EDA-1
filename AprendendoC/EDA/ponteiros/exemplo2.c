...
void trocarValores(float *ptr1, float *ptr2) { //ptr1 ta sendo passado para &a e ptr2 ta sendo passado para &b
float temp = *ptr1; //Armazena o valor de ptr1 em uma variáv
